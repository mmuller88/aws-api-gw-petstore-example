...
export function openApi(stage: string): openapi.OpenAPIObjectAWS {
  return {
    openapi: '3.0.2',
    info: {
      title: 'Swagger Petstore - OpenAPI 3.0',
      description: `This file ist auto generated from src/openapi.ts! That's the ${stage} deployment. This is a sample Pet Store Server based on the OpenAPI 3.0 specification.  You can find out more about\nSwagger at [http://swagger.io](http://swagger.io). In the third iteration of the pet store, we've switched to the design first approach!\nYou can now help us improve the API whether it's by making changes to the definition itself or to the code.\nThat way, with time, we can improve the API in general, and expose some of the new features in OAS3.\n\nSome useful links:\n- [The Pet Store repository](https://github.com/swagger-api/swagger-petstore)\n- [The source API definition for the Pet Store](https://github.com/swagger-api/swagger-petstore/blob/master/src/main/resources/openapi.yaml)`,
    ...
    paths: {
      ...
      // only appy user endpoints to dev stage
      ...(stage === 'dev' ? {
        '/user': {
          post: {
            'tags': ['user'],
